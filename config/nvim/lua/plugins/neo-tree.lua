return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "<leader>nt", ":Neotree filesystem reveal left<CR>", { desc = "Reveal filesystem" })
    vim.keymap.set("n", "<leader>bf", ":Neotree buffers reveal float<CR>", { desc = "Reveal open buffers" })
  end,
}
